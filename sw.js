const CACHE='finance-os-v1.7.1-build-20260915-01';
const ASSETS=['./','./index.html','./styles.css?v=1.7.1','./core.js?v=1.7.1','./app.js?v=1.7.1','./manifest.webmanifest?v=1.7.1','./icon-192.png?v=1.7.1','./icon-512.png'];
