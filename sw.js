const CACHE='finance-os-v1.7.2-build-20260917-01';
const ASSETS=['./','./index.html','./styles.css?v=1.7.2','./core.js?v=1.7.2','./app.js?v=1.7.2','./manifest.webmanifest?v=1.7.2','./icon-192.png?v=1.7.2','./icon-512.png'];
