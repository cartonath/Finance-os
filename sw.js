const CACHE='finance-os-v1.6.8-build-20260913-11';
const ASSETS=['./','./index.html','./styles.css?v=1.6.8','./core.js?v=1.6.8','./app.js?v=1.6.8','./manifest.webmanifest?v=1.6.8','./icon-192.png?v=1.6.8','./icon-512.png'];
