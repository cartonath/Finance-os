const CACHE='finance-os-v1.6.7-build-20260913-10';
const ASSETS=['./','./index.html','./styles.css?v=1.6.7','./core.js?v=1.6.7','./app.js?v=1.6.7','./manifest.webmanifest?v=1.6.7','./icon-192.png?v=1.6.7','./icon-512.png'];
