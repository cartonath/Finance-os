const CACHE='finance-os-v1.7.4-build-20260918-01';
const ASSETS=['./','./index.html','./styles.css?v=1.7.4','./core.js?v=1.7.4','./app.js?v=1.7.4','./manifest.webmanifest?v=1.7.4','./icon-192.png?v=1.7.4','./icon-512.png'];
