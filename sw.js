const CACHE='finance-os-v1.6.9-build-20260913-12';
const ASSETS=['./','./index.html','./styles.css?v=1.6.9','./core.js?v=1.6.9','./app.js?v=1.6.9','./manifest.webmanifest?v=1.6.9','./icon-192.png?v=1.6.9','./icon-512.png'];
