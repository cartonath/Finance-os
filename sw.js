const CACHE='finance-os-v1.7.0-build-20260914-01';
const ASSETS=['./','./index.html','./styles.css?v=1.7.0','./core.js?v=1.7.0','./app.js?v=1.7.0','./manifest.webmanifest?v=1.7.0','./icon-192.png?v=1.7.0','./icon-512.png'];
