const CACHE='finance-os-v1.7.3-build-20260917-02';
const ASSETS=['./','./index.html','./styles.css?v=1.7.3','./core.js?v=1.7.3','./app.js?v=1.7.3','./manifest.webmanifest?v=1.7.3','./icon-192.png?v=1.7.3','./icon-512.png'];
